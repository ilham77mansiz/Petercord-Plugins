...
from petercord import petercord, Message, get_collection, Config
...
@petercord.on_cmd(
    "delnote", about={
        ...
        'petercord': "{tr}delnote [note name]\n{tr}delnote -all"},
    allow_channels=False, allow_bots=False)
...
@petercord.on_cmd(
    r"addnote (\S+)(?:\s([\s\S]+))?", about={
        ...
        'petercord': "{tr}addnote [note name] [content | reply to msg]",
