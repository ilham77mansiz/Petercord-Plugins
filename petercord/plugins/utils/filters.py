...
from petercord import petercord, Message, filters, get_collection
...
@petercord.on_cmd(
    r"addfilter ([^\s\|][^\|]*)(?:\s?\|\s?([\s\S]+))?", about={
        ...
        'petercord': "{tr}addfilter [filter name | filter type] | [content | reply to msg]",
...
@petercord.on_filters(~filters.me & ~filters.edited & FILTERS_CHATS, group=1)
