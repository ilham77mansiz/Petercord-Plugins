...
from petercord import petercord, Message, filters, Config, get_collection
...
@petercord.on_cmd("afk", about={
    ...
    'petercord': "{tr}afk or {tr}afk [reason]"}, allow_channels=False)
...
@petercord.on_filters(IS_AFK_FILTER & ~filters.me & ~filters.bot & ~filters.edited & (
