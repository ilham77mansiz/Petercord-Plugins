...
@petercord.on_cmd("setwelcome", about={
...
@petercord.on_cmd("setleft", about={
...
@petercord.on_cmd("nowelcome", about={
...
@petercord.on_cmd("dowelcome", about={
...
@petercord.on_cmd("delwelcome", about={
...
@petercord.on_cmd("delleft", about={
...
@petercord.on_cmd("vwelcome", about={
