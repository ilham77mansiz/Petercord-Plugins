...
* With Docker 🐳 
    <a href="https://github.com/ilham77mansiz/Petercord-Plugins/blob/Petercord-Userbot/resources/readmeDocker.md"><b>See Detailed Guide</b></a>

* With Git, Python and pip 🔧
  ```bash
  # clone the repo
  git clone https://github.com/ilham77mansiz/Petercord-Plugins.git
  cd userge-x
...
```python
from petercord import petercord, Message, filters

LOG = petercord.getLogger(__name__)  # logger object
CHANNEL = petercord.getCLogger(__name__)  # channel logger object

# add command handler
@petercord.on_cmd("test", about="help text to this command")
...
# add filters handler
@petercord.on_filters(filters.me & filters.private)  # filter my private messages
